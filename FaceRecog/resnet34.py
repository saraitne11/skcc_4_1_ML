...
# def build_resnet34(X, is_train, num_class):
def build_resnet(X, is_train, num_class):
    batch_norm_decay = 0.997
    batch_norm_epsilon = 1e-5
    net = tf.layers.conv2d(X, 64, [7, 7], strides=[2, 2], padding='SAME', use_bias=False,
                           kernel_initializer=tf.initializers.variance_scaling(),
                           name='stem_conv1')
    ...
    net = residual_block(net, 64, is_train, batch_norm_decay, batch_norm_epsilon, name='res_block2')
    net = residual_block(net, 64, is_train, batch_norm_decay, batch_norm_epsilon, name='res_block3')

    net = residual_block_down_sample(net, 128, is_train,
                                     batch_norm_decay, batch_norm_epsilon, name='res_block4')
    net = residual_block(net, 128, is_train, batch_norm_decay, batch_norm_epsilon, name='res_block5')
    net = residual_block(net, 128, is_train, batch_norm_decay, batch_norm_epsilon, name='res_block6')
    net = residual_block(net, 128, is_train, batch_norm_decay, batch_norm_epsilon, name='res_block7')

    net = residual_block_down_sample(net, 256, is_train,
                                     batch_norm_decay, batch_norm_epsilon, name='res_block8')
    net = residual_block(net, 256, is_train, batch_norm_decay, batch_norm_epsilon, name='res_block9')
    net = residual_block(net, 256, is_train, batch_norm_decay, batch_norm_epsilon, name='res_block10')
    net = residual_block(net, 256, is_train, batch_norm_decay, batch_norm_epsilon, name='res_block11')
    net = residual_block(net, 256, is_train, batch_norm_decay, batch_norm_epsilon, name='res_block12')
    net = residual_block(net, 256, is_train, batch_norm_decay, batch_norm_epsilon, name='res_block13')

    net = residual_block_down_sample(net, 512, is_train,
                                     batch_norm_decay, batch_norm_epsilon, name='res_block14')
    net = residual_block(net, 512, is_train, batch_norm_decay, batch_norm_epsilon, name='res_block15')
    net = residual_block(net, 512, is_train, batch_norm_decay, batch_norm_epsilon, name='res_block16')
