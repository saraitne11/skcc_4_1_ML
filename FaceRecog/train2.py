...
classifier = CNN('resnet26_dr', 6, [128, 128, 3], weight_decay=5e-3)

sess = tf.Session(config=get_tf_config())
classifier.train(sess, train_data, val_data, 5000, 1e-4, 64)
classifier.train(sess, train_data, val_data, 10000, 1e-5, 64, ckpt='step-5000')
